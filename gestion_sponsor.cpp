...
bool Gestion_Sponsor::ajouter()
{
    ...
    query.prepare("INSERT INTO SPONSOR (ID_SPONSOR, CODE_UNIQUE, NOM_SPONSOR, SECTEUR_ACTIVITE, MONTANT) "
...
QSqlQueryModel* Gestion_Sponsor::afficher()
{
    ...
    model->setQuery("SELECT ID_SPONSOR, CODE_UNIQUE, NOM_SPONSOR, SECTEUR_ACTIVITE, MONTANT FROM SPONSOR");
...
bool Gestion_Sponsor::modifier(int id)
{
    ...
    query.prepare("UPDATE SPONSOR SET CODE_UNIQUE = :code, NOM_SPONSOR = :nom, "
                  "SECTEUR_ACTIVITE = :secteur, MONTANT = :montant "
                  "WHERE ID_SPONSOR = :id");
...
QSqlQueryModel* Gestion_Sponsor::rechercher(QString critere)
{
    ...
    QString queryStr = "SELECT ID_SPONSOR, CODE_UNIQUE, NOM_SPONSOR, SECTEUR_ACTIVITE, MONTANT "
                       "FROM SPONSOR WHERE NOM_SPONSOR LIKE '%" + critere + "%' "
                                   "OR SECTEUR_ACTIVITE LIKE '%" + critere + "%'";
